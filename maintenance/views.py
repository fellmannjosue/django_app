...
def maintenance_dashboard(request):
    ...
    return render(request, 'maintenance/maintenance_dashboard.html', {'form': form, 'records': records})
...
def download_maintenance_pdf(request, record_id):
    ...
    pdf.drawCentredString(card_width / 2, margin, "Sistema de Mantenimiento - Nuevo Amanecer Asociados")
